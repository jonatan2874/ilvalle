...
<html>
<head>
<title>ILValle Admin web | Home</title>
					...
					?>
						...
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								...
								<div class="stats">
								  <h5>Ingresos <br>Retenciones </h5>
								  <div class="grow">
									<p style="cursor: pointer;" onclick="descargarCertificadoEmp()">Descargar</p>
								  </div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								...
								<div class="stats">
								  ...
								  <div class="grow">
									<p style="cursor: pointer;" onclick="descargarCertificado('fuente')">Descargar</p>
								  </div>
								</div>
							</div>
						</div>
							...
							<div class="r3_counter_box">
								...
								<div class="stats">
								  ...
								  <div class="grow grow1">
									<p style="cursor: pointer;" onclick="descargarCertificado('iva')">Descargar</p>
								  </div>
								</div>
							</div>
						</div>
							...
							<div class="r3_counter_box">
								...
								<div class="stats">
								  ...
								  <div class="grow grow3">
									<p style="cursor: pointer;" onclick="descargarCertificado('ica')">Descargar</p>
								  </div>
								</div>
							</div>
						 </div>
							...
							<div class="r3_counter_box">
								...
								<div class="stats">
								  ...
								  <div class="grow grow2">
									<p style="cursor: pointer;" onclick="descargarCertificado('estampillas')">Descargar</p>
								  </div>
								</div>
							</div>
						</div>
...
<script>
	var descargarCertificado=(type)=>{
		var anio = prompt("Por favor digite el año", "2018");

		if (anio == null) {
		  alert("debe digitar el año");
		  return;
		}
		window.open("backend/users/controller.php?method=certificado&nit=<?= @$_SESSION[DOCUMENTOUSUARIO] ?>&typeCert="+type+"&anio="+anio);
	}

	var descargarCertificadoEmp = ()=>{
		var anio = prompt("Por favor digite el año", "2018");
		...
		window.open("backend/users/controller.php?method=certificadoEmp&documento=<?= @$_SESSION[DOCUMENTOUSUARIO] ?>&anio="+anio);
	}
</script>
</body>
</html>