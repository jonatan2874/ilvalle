<?php
	...
	$sql   = "SELECT  
					...
					password,
					rol
				FROM users WHERE id=$_SESSION[IDUSUARIO]";
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="">
	...
	<!-- //header-ends -->
			...
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Modificar Perfil</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" id="fupForm">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text"  class="form-control1" readonly="readonly" id="documento">
									</div>
								</div>
								<div class="form-group">
									<label for="nombre" class="col-sm-2 control-label">Digito verificacion</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" readonly="readonly" id="dv">
									</div>
								</div>
								<div class="form-group">
									<label for="nombre" class="col-sm-2 control-label">Nombre</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" readonly="readonly" name="nombre" id="nombre" >
									</div>
								</div>
								<div class="form-group">
									<label for="descripcion" class="col-sm-2 control-label">Nombre de usuario</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" readonly="readonly" id="user_name">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" readonly="readonly" id="rol">
									</div>
								</div>
							  	<input type="hidden" name="id_user" id="id_user" value="<?= $_SESSION['IDUSUARIO']; ?>">
							</form>
							<div class="panel-footer">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									<button class="btn-success btn" onclick="saveProfile()">Guardar</button>
...
<script>
	...
	$(document).ready(function(e){
		$("#fupForm").on('submit', function(e){
	        ...
	        $.ajax({
				type        : 'POST',
				url         : 'backend/users/controller.php?method=editProfile',
	            ...
	            success: function(result){
					...
					if (response.response=='success') { 
						...
						if ($("#id_user").val()>0){ window.location = "index.php"; }
					}
